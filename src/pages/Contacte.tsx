...
export default function Contact() {
  ...
  const socials = [
    ...
    { icon: <LinkedinIcon size={20} />, label: 'LinkedIn', href: 'https://www.linkedin.com/in/nambinintsoa-gilbert-nomenjanahary-8867b9372', value: 'Nambinintsoa Gilbert Nomenjanahary' },
